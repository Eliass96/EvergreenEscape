...
var pug_match_html=/["&<>]/;function chatFriends(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (mensajes, nombreUsuario) {pug_html = pug_html + "\u003Coutput class=\"cardChat\" id=\"chatBox\"\u003E\u003Cdiv class=\"card-inner-chat\"\u003E\u003Cheader class=\"d-flex align-items-center justify-content-center p-lg-3\"\u003E\u003Ch2 class=\"titulo_card_chat\"\u003E\u003Cspan id=\"chatNombreUsuario\"\u003E" + (pug_escape(null == (pug_interp = nombreUsuario) ? "" : pug_interp)) + "\u003C\u002Fspan\u003E\u003C\u002Fh2\u003E\u003Cbutton class=\"btn btn-custom boton_cerrar\" id=\"cerrarChat\"\u003E❌\u003C\u002Fbutton\u003E\u003C\u002Fheader\u003E\u003C!-- Spinner en lugar de la lista de mensajes al principio--\u003E\u003Cdiv id=\"spinner\" style=\"display: none; text-align: center; padding: 2rem;\"\u003E\u003Cdiv class=\"loader\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C!-- Lista de mensajes--\u003E\u003Cul class=\"lista_chat\" id=\"listaMensajes\" style=\"display: none;\"\u003E";
// iterate mensajes
;(function(){
  var $$obj = mensajes;
